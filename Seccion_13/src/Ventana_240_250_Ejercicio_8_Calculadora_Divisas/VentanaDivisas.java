...
public class VentanaDivisas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panel, javax.swing.GroupLayout.DEFAULT_SIZE, 811, Short.MAX_VALUE)
        );
    ...
    private void cambioDivisa() {
        if (divisa1.equals(divisa2)) {
            ...
            if (divisa1.equals("Estados Unidos - Dólar") && divisa2.equals("Perú - Nuevo Sol")) {
                cambio = 3.25;
            } else {
                if (divisa1.equals("Estados Unidos - Dólar") && divisa2.equals("Europa - Euro")) {
                    cambio = 0.84;
                } else {
                    if (divisa1.equals("Perú - Nuevo Sol") && divisa2.equals("Estados Unidos - Dólar")) {
                        cambio = 0.32;
                    } else {
                        if (divisa1.equals("Perú - Nuevo Sol") && divisa2.equals("Europa - Euro")) {
                            cambio = 0.26;
                        } else {
                            if (divisa1.equals("Europa - Euro") && divisa2.equals("Estados Unidos - Dólar")) {
                                cambio = 1.2;
                            } else {
                                if (divisa1.equals("Europa - Euro") && divisa2.equals("Perú - Nuevo Sol")) {
                                    cambio = 3.91;
                                }
                            }
                        }
